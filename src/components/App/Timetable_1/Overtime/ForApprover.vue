                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-right">
                                            <span v-if="update_approvals_loading == false">
                                                <button type="button" class="btn btn-danger" @click="updateApproval(form,'declined')" v-if="form.status == 'pending'"><i class="fa fa-times-circle"></i></button>
                                                <button type="button" class="btn btn-success" @click="updateApproval(form,'approved')" v-if="form.status == 'pending'"><i class="fa fa-check-circle"></i></button>
                                            </span>
                                            <span v-else>
                                                <button class="btn btn-default"><i class="fa fa-refresh fa-spin"></i></button>
                                            </span>                                            
                                        </div>
                                    </div>
                                </div>
