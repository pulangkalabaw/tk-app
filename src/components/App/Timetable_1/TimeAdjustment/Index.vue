                            		...
                            		<!-- start of inside codable(component) -->
										...
										<!-- <div class="row">
											<div class="col-md-6 text-left">
												<button class="btn btn-info" @click="requestAdjustmentBtn()">Request for adjustment</button>
												<br><br>
											</div>
											<div class="col-md-6 text-right">
		                						<i class="fa fa-info-circle text-info"></i> <small class="text-info">Please click on a data to see info about time adjustment request</small>										
											</div>
										</div> -->
										...
										<div>
											...
											<ul class="nav nav-tabs">
												...
												<li>
													<a data-toggle="tab" href="#approvedTab">Approved <span class="label" v-if="approvals">{{ approvedApprovals.length }}</span></a>
												</li>
												<li>
													<a data-toggle="tab" href="#declinedTab">Declined <span class="label" v-if="approvals">{{ declinedApprovals.length }}</span></a>
												</li>
												<li>
												...
												<div id="pendingTab" class="tab-pane fade in active">
													<div  v-if="approvals">
														...
														<table class="datatable table table-hover">
															...
															<tbody>
																<tr class="text-center" v-for="approval in pendingApprovals"  @click="modalBtn(approval)">
																...
																<!-- <td>
																	<button class="btn btn-info btn-xs" type="button" data-toggle="modal" data-target="#adjustmentModal" title="Open time adjustment form" @click="modalBtn(approval)"><i class="fa fa-file-text"></i></button>
																</td> -->
															</tr>
														</tbody>
													</table>
											...
											<!-- approved -->
											<div id="approvedTab" class="tab-pane fade" v-if="approvals">
												<!-- inside if there is timetable -->
												<table class="datatable table table-hover">
													<thead>
														<tr>
													...
													<tbody>
														<tr class="text-center" v-for="approval in approvedApprovals"  @click="modalBtn(approval)">
															<td>{{ approval.date_in }}</td>
															<td><span v-if="approval.time_in">{{ toHumanTime(approval.time_in) }}</span></td>
															<td><span v-if="approval.time_out">{{ toHumanTime(approval.time_out) }}</span></td>
															<td><span v-if="approval.shift_in">{{ toHumanTime(approval.shift_in) + ' - ' + toHumanTime(approval.shift_out) }}</span></td>
												...
												<!-- declined -->
												<div id="declinedTab" class="tab-pane fade" v-if="approvals">
													<!-- inside if there is timetable -->
													<table class="datatable table table-hover">
														<thead>
															<tr>
														...
														<tbody>
															<tr class="text-center" v-for="approval in declinedApprovals"  @click="modalBtn(approval)">
																<td>{{ approval.date_in }}</td>
																<td><span v-if="approval.time_in">{{ toHumanTime(approval.time_in) }}</span></td>
																<td><span v-if="approval.time_out">{{ toHumanTime(approval.time_out) }}</span></td>
																<td><span v-if="approval.shift_in">{{ toHumanTime(approval.shift_in) + ' - ' + toHumanTime(approval.shift_out) }}</span></td>
															...
															<div class="col-md-6">
																...
																<div class="breadcrumb">
																	...
																	<div class="row" v-if="!isEditing">
																		...
																		<div class="col-md-4"><strong>Day Type:</strong></div>
																		<div class="col-md-8">
																			<!-- <span v-if="form.old_day_type">{{ form.old_day_type }}</span><br> -->
