                                        ...
                                        <table class="datatable table table-hover">
                                            ...
                                            <tbody>
                                                <tr v-for="time in approvals" class="text-center" @click="modalBtn(time)">
                                                    ...
                                                    <td>{{ time.day_type }}</td>
                                                    <td>
                                                        <i data-toggle="tooltip" title="Approved" class="fa fa-check-circle text-success" v-if="time.status == 'approved'"></i>
                                                        <i data-toggle="tooltip" title="Declined" class="fa fa-times-circle text-danger" v-if="time.status == 'declined'"></i>
                                                        <i data-toggle="tooltip" title="Pending" class="fa fa-circle-o text-warning" v-if="time.status == 'pending'"></i>
                                                    </td>
                                                    <td width="30%">{{ time.reason }}</td>
                                                </tr>
                                            </tbody>
