            ...
            <div class="sidebar__cont">
                ...
                <div class="sidebar__menu" v-if="(['HR Admin', 'Admin']).includes($session.get('auth')['role'][0]['role_name'])">
                    ...
                    <ul class="nav nav-menu">
                        ...
                        <li :class="{ 'active': $route.name == 'employees.summary_report' }">
                            <a class="nav-link" style="cursor: pointer;" @click="redirect('employees.summary_report', { tenant: $route.params.tenant })">
                ...
                <div class="sidebar__menu" v-if="(['HR Admin', 'Admin', 'Employee', 'Time Keeping']).includes($session.get('auth')['role'][0]['role_name'])">
                    ...
                    <ul class="nav nav-menu">
                        ...
                        <li :class="{ 'active': $route.name == 'overtime.approvee' }">
                            <a class="nav-link" style="cursor: pointer;" @click="redirect('overtime.approvee', { tenant: $route.params.tenant })">
                                <div class="nav-menu__ico"><i class="fa fa-fw fa-hourglass-3"></i></div>
                                <div class="nav-menu__text"><span>Overtime Requests</span></div>
                            </a>
                        </li>
                    ...
                    <div v-if="$session.get('auth')['is_approver'] == 1">
                        ...
                        <ul class="nav nav-menu">
                            ...
                            <li :class="{ 'active': $route.name == 'profile.approver' }">
                                <a class="nav-link" style="cursor: pointer;" @click="redirect('profile.approver', { tenant: $route.params.tenant })">
                                    <div class="nav-menu__ico"><i class="fa fa-fw fa-users"></i></div>
                                    <div class="nav-menu__text"><span>Approver Employee</span></div>
                                </a>
                            </li>
                            ...
                            <li :class="{ 'active': $route.name == 'overtime.approver' }" >
                                <a class="nav-link" style="cursor: pointer;" @click="redirect('overtime.approver', { tenant: $route.params.tenant })">
                                    <div class="nav-menu__ico"><i class="fa fa-fw fa-hourglass"></i></div>
                                    <div class="nav-menu__text"><span>Overtime Approvals</span></div>
                                </a>
                            </li>
                ...
                <div class="sidebar__menu" v-if="(['HR Admin', 'Admin']).includes($session.get('auth')['role'][0]['role_name'])">
                    ...
                    <ul class="nav nav-menu">
                        ...
                        <li :class="{ 'active': $route.name == 'leave_types.index' }">
                            <a style="cursor: pointer;" @click="redirect('leave_types.index', { tenant: $route.params.tenant })">
                                <div class="nav-menu__ico"><i class="fa fa-fw fa-bookmark-o"></i></div>
                                <div class="nav-menu__text"><span>Leave Types Settings</span></div>
                            </a>
                        </li>
                        <li :class="{ 'active': $route.name == 'holiday_types.index' }">
                            <a style="cursor: pointer;" @click="redirect('holiday_types.index', { tenant: $route.params.tenant })">
                                <div class="nav-menu__ico"><i class="fa fa-fw fa-bookmark-o"></i></div>
                                <div class="nav-menu__text"><span>Holiday Types Settings</span></div>
                            </a>
                        </li>
